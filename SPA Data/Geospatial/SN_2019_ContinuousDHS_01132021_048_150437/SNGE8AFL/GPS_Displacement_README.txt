Dataset: SNGE8AFL
Displacement Restriction: Department (Admin 2)
...
Restricted to admin 2:
The displacement is restricted so that the points stay within the country, within the DHS survey region, and within
the admin 2 area. Therefore, the displaced cluster's coordinates are located within the same admin 0, admin 1,
and admin 2 areas as the undisplaced cluster.
