Dataset: MWGE7AFL
Displacement Restriction: Districts (admin1)
...
Restricted to Districts:
The displacement is restricted so that the points stay within the country, within the DHS survey region, and within
the Districts. Therefore, the displaced cluster's coordinates are located within the same Country, Region,
and District areas as the undisplaced cluster.
